...
- **Total files**: 97
- **Total `def test_*` functions**: 1099
...
| `test_phase_85_cloud_deployment_contract.py` | 23 | critical | yes | not_reviewed | Phase-85 (2026-05-20): cloud-deployment + ntfy + loose-mode contract. |
