...
- **Total files**: 94
- **Total `def test_*` functions**: 1048
...
| `test_phase_80_spread_in_backtest.py` | 11 | critical | yes | not_reviewed | Phase-80 (2026-05-19): realistic bid/ask spread in backtest. |
